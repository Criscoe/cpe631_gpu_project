...
axes[3,0].plot(size, dataDf['MEMSETTotalDuration'], label="MEMSET TotalDuration")
axes[3,0].set_xlabel('Size (w x h pixels)')
axes[3,0].set_ylabel('Execution Time (Nanoseconds)')

axes[1,0].plot(size, dataDf['MEMCPYTotalDuration'], label="MEMCPY TotalDuration")
axes[1,0].set_xlabel('Size (w x h pixels)')
axes[1,0].set_ylabel('Execution Time (Nanoseconds)')

axes[2,0].plot(size, dataDf["MEMCPYBytes"], label="MEMCPY Bytes")
axes[2,0].set_xlabel('Size (w x h pixels)')
axes[2,0].set_ylabel('Bytes Copied (Bytes)')

axes[0,0].plot(size, dataDf["RUNTIMETotalDuration"], label="RUNTIME TotalDuration")
axes[0,0].set_xlabel('Size (w x h pixels)')
axes[0,0].set_ylabel('Execution Time (Nanoseconds)')


axes[3,1].set_visible(False) 
axes[1,1].plot(size, dataDfG['MEMCPYTotalDuration'], label="MEMCPY TotalDuration")
axes[1,1].set_xlabel('Size (w x h pixels)')
axes[1,1].set_ylabel('Execution Time (Nanoseconds)')

axes[2,1].plot(size, dataDfG["MEMCPYBytes"], label="MEMCPY Bytes")
axes[2,1].set_xlabel('Size (w x h pixels)')
axes[2,1].set_ylabel('Bytes Copied (Bytes)')

axes[0,1].plot(size, dataDfG["RUNTIMETotalDuration"], label="RUNTIME TotalDuration")
axes[0,1].set_xlabel('Size (w x h pixels)')
axes[0,1].set_ylabel('Execution Time (Nanoseconds)')

axes[3,0].set_title("MEMSET TotalDuration (Nanoseconds) vs Size (w x h pixels)")
axes[1,0].set_title("MEMCPY TotalDuration (Nanoseconds) vs Size (w x h pixels)")
axes[2,0].set_title("MEMCPY Bytes Copied (Bytes) vs Size (w x h pixels)")
axes[0,0].set_title("RUNTIME TotalDuration (Nanoseconds) vs Size (w x h pixels)")

# axes[0,1].set_title("TotalDuration (Nanoseconds) vs Size (w x h pixels) Gauss")
axes[1,1].set_title("MEMCPY TotalDuration (Nanoseconds) vs Size (w x h pixels) Gauss")
axes[2,1].set_title("MEMCPY Bytes Copied (Bytes) vs Size (w x h pixels) Gauss")
axes[0,1].set_title("RUNTIME TotalDuration (Nanoseconds) vs Size (w x h pixels) Gauss")
